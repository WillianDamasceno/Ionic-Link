		...
		<main className='grid place-items-center min-h-screen p-8 bg-gray-100'>
			<div className='container h-max p-8 md:p-16 rounded-3xl bg-white shadow-lg'>
				...
				<p className='text-gray-600'>
					This website is in development, and its main idea is to be a Link Tree, where you can register
					unlimited links that have a slug, or just a short version of it.
				</p>
				...
				<div className='flex gap-4'>
					<Link href='/auth/login'>
						<button
							type='button'
							className='
							w-max py-2 px-6 md:px-8 rounded
							text-white bg-purple-600 hover:bg-purple-700 active:bg-purple-600
							outline-offset-2 accent-slate-700 transition'
						>
							Login
						</button>
					</Link>
					...
					<Link href='/auth/register'>
						<button
							type='button'
							className='w-fit py-2 px-3 md:px-4 rounded
							text-purple-800 active:text-white hover:bg-gray-300
							outline-offset-2 active:bg-gray-500 transition'
						>
							Sign Up
						</button>
					</Link>
